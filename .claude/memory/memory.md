...
|------|-------------|--------------|
| `general.md` | Project structure, code style, architecture, main screen layout, key patterns | 2026-05-16 |
| `domain/esp32-s3-lvgl.md` | Hardware pins, LovyanGFX config, LVGL 9 init, **confirmed working flush callback (pushImage + lv_refr_now)**, LittleFS label bug, fallback buf size bug, LCD_CAM interrupt fix | 2026-05-16 |
